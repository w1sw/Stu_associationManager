    ...
    <div class="content-break">
        <div class="wrapper">
            <div class="page-title">
                <h3 class="colored">优秀社团展示</h3>
                <p><a href="index.jsp">主页</a> / <a href="pages.jsp">社团信息</a> / <a href="our-company.jsp">优秀社团展示</a> / </p>
            </div>           
		</div>
    </div>        
    <!-- END SLIDER -->
        ...
        <div class="one notopmargin">
            <div class="one-fourth left">
                ...
                <ul class="content-navigation">
                    <li>社团信息
                        <ul>
                            <li ><a href="allAssociations_1.jsp" target="frmCenter">查看所有社团</a></li>
            ...
            <div class="inner-content notopmargin last">
                <div class="three-fourth last">
                    <div class="header-three-fourth">
                    	<div class="header-content">本年度优秀社团</div>
                	</div>
                    <div class="one-fourth notopmargin">
                    	
                    </div>
                    <p>每个学年我们都会评选出最优秀的社团，以此鼓励同学们不断进步，同时也不断地发展壮大自己的社团</p>
                </div>
                <div class="one-fourth">
                    <div class="header-one-fourth">
                        <div class="header-content">街舞社</div>
                    </div>
                    <a href="images/slide-1-1.jpg" class="item-preview" rel="prettyPhoto" title=""><img class="bordered-img img-preview"  src="images/gallery/one-fourth-image-portrait-1.jpg" alt=" "/></a>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris a ipsum ut odio lobortis consequat nec at orci. Sed porttitor enim in neque consectetur sit.</p>
                </div>
                <div class="one-fourth">
                    <div class="header-one-fourth">
                        <div class="header-content">Schwarzenegger</div>
                    </div>
                    <a href="images/slide-1-1.jpg" class="item-preview" rel="prettyPhoto" title=""><img class="bordered-img img-preview"  src="images/gallery/one-fourth-image-portrait-2.jpg" alt=" "/></a>
                    <p> Pellentesque ac ipsum ligula, sit amet sodales odio. Suspendisse blandit sem a turpis pulvinar malesuada. Sed eget sem et neque varius lacinia nec eu lectus. </p>
                </div>
                <div class="one-fourth last">
                    <div class="header-one-fourth">
                    	<div class="header-content">Keanu Reeves</div>
                    </div>
                    <a href="images/slide-1-1.jpg" class="item-preview" rel="prettyPhoto" title=""><img class="bordered-img img-preview"  src="images/gallery/one-fourth-image-portrait-3.jpg" alt=" "/></a>
                    <p> Aenean sapien enim, rutrum in accumsan vitae, egestas id nibh. Curabitur et magna arcu. Vivamus eu justo quis erat scelerisque auctor.</p>
                </div>
                <div class="one-fourth">
                    <div class="header-one-fourth">
                        <div class="header-content">David Statham</div>
                    </div>
                    <a href="images/slide-1-1.jpg" class="item-preview" rel="prettyPhoto" title=""><img class="bordered-img img-preview"  src="images/gallery/one-fourth-image-portrait-4.jpg" alt=" "/></a>
                    <p> Sed porttitor enim in neque consectetur sit amet porttitor orci commodo. Maecenas ac ante interdum magna rhoncus aliquet vel ac massa. Proin tristique enim non massa laoreet sollicitudin.</p>
                </div>
                <div class="one-fourth">
                    <div class="header-one-fourth">
                        <div class="header-content">Elizabeth Hurley</div>
                    </div>
                    <a href="images/slide-1-1.jpg" class="item-preview" rel="prettyPhoto" title=""><img class="bordered-img img-preview"  src="images/gallery/one-fourth-image-portrait-5.jpg" alt=" "/></a>
                    <p>Nam adipiscing erat eu odio consectetur sed scelerisque neque suscipit. Proin tincidunt sodales dignissim. Pellentesque ac ipsum ligula, sit amet sodales odio. Suspendisse blandit sem a turpis pulvinar malesuada</p>
                </div>
                <div class="one-fourth last">
                    <div class="header-one-fourth">
                    	<div class="header-content">Mariah Carey</div>
                    </div>
                    <a href="images/slide-1-1.jpg" class="item-preview" rel="prettyPhoto" title=""><img class="bordered-img img-preview"  src="images/gallery/one-fourth-image-portrait-6.jpg" alt=" "/></a>
                    <p> Aenean sapien enim, rutrum in accumsan vitae, egestas id nibh. Curabitur et magna arcu. Vivamus eu justo quis erat scelerisque auctor. Proin euismod tortor vel magna auctor sed.</p>
                </div>   
            </div>
        </div>
